...
const ProgressBar = ({ value }) => {
  ...
  const leftValue = isLeftNegative ? Math.abs(value) : 0;
  const rightValue = isRightNegative ? value : 0;
  ...
  return (
    <div className="mb-5 ml-5 flex flex-cols gap-5 items-end mt-10">
      <div className="h-72 w-12 overflow-hidden rounded-md bg-gray-300">
